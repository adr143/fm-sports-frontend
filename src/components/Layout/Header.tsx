...
const Header = () => {
  ...
  return <header className="bg-white w-screen shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 md:flex-none text-center md:text-left">
            <Link to="/" className="flex justify-center item-center gap-2 text-xl md:text-2xl  font-bold text-black">
